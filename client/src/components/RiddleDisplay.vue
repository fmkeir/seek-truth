    ...
    <form class="landing-form" @submit.prevent="handleSubmit">
      ...
      <div class="page-container" id="secret-document">
        ...
        <p class="paragraph centered" id="last-paragraph">
          ...
          <span class="blackout">
          Congue nisi vitae suscipit tellus mauris. Mi sit amet mauris commodo quis imperdiet massa tincidunt nunc. Sit amet tellus cras adipiscing enim eu turpis egestas pretium. Sed blandit libero volutpat sed cras ornare arcu. Sapien et ligula ullamcorper malesuada. Rutrum quisque non tellus orci ac auctor. Et odio pellentesque diam volutpat commodo sed egestas. Id consectetur purus ut faucibus pulvinar.</span> People will be asked to self-isolate for seven days after showing mild symptoms under the new approach, the UK's chief medical adviser Prof Chris Whitty said.
